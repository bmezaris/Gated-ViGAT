...
parser.add_argument('--dataset', default='minikinetics', choices=['fcvid', 'minikinetics', 'actnet'])
parser.add_argument('--dataset_root', default='/m2/dimidask/Projects/miniKinetics_130k', help='dataset root directory')
parser.add_argument('--lr', type=float, default=1e-4, help='initial learning rate')
parser.add_argument('--milestones', nargs="+", type=int, default=[70, 110], help='milestones of learning decay')
parser.add_argument('--num_epochs', type=int, default=130, help='number of epochs to train')
...
def main():
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        if (epoch + 1) % args.save_interval == 0:
            sfnametmpl = 'model-{}_130k-120frames70110-{:03d}.pt'
